...
// Componentes auditáveis do sistema.
// Use estes nomes ao chamar recordAuditEvent para manter consistência.
...
// Tipos de evento mais comuns. Você pode usar outros nomes,
// mas estes ajudam o C-Level Auditor a entender o que aconteceu.
...
// Gera um trace_id único para cada mensagem recebida.
// Todos os eventos disparados durante o processamento dessa mensagem
// devem usar o mesmo trace_id para podermos reconstruir a sequência.
...
// Mascara campos sensíveis antes de salvar no audit_events.
// Não mascara objetos completos, só faz limpeza superficial de PII óbvia.
...
// Aproxima o tamanho em tokens de um texto.
// Não é exato como o tiktoken, mas é suficiente para auditoria.
...
/**
 * Grava um evento de auditoria no MongoDB.
 *
 * @param {Object} options
 * @param {string} options.traceId - ID único da requisição (agrupa eventos)
 * @param {string} options.component - Um valor de AUDIT_COMPONENTS
 * @param {string} options.eventType - Um valor de AUDIT_EVENT_TYPES
 * @param {Object} options.payload - Dados detalhados do evento
 * @param {string} [options.requiredLevel] - Nível mínimo (BASIC, STANDARD, DEEP, FORENSIC)
 * @p
